...
public final class AddOnProductMessages {
    private AddOnProductMessages() {}

    public static final String ADDON_PRODUCT_ADDED_SUCCESSFULLY = "Add on product added successfully";
