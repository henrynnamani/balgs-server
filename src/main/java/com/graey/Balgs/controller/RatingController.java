...
public class RatingController {
    ...
    public ResponseEntity<ApiResponse<String>> rateVendor(@RequestBody RateVendor rateVendor, @AuthenticationPrincipal User user) {
        return service.rateVendor(rateVendor, user);
    }
}
